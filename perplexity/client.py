    ...
    def search(
        ...
        assert (
            ...
            in {
                ...
                "reasoning": [None, "gpt-5.2-thinking", "claude-4.5-sonnet-thinking", "claude-4.5-opus-thinking", "claude-4.6-sonnet-thinking", "claude-4.6-opus-thinking", "claude-4.7-opus-thinking", "claude-4.8-opus-thinking", "gemini-3.0-pro", "kimi-k2-thinking", "kimi-k2.5-thinking", "grok-4.1-reasoning"],
                "deep research": [None],
            }[mode]
            if self.own
            else True
        ...
        for filename, file in files.items():
            ...
            # Validate file upload info response
            if not file_upload_info or "fields" not in file_upload_info or file_upload_info["fields"] is None:
                if file_upload_info.get("rate_limited"):
                    raise Exception("File upload rate limited. Please wait a while before uploading more files.")
                raise Exception(f"Invalid file upload response: {file_upload_info}")
